...
### הצד של אדר
- `admin-clients.html` — עמוד נפרד (לא נגענו במונוליט של 201KB): יצירת לקוח, כתיבת האימונים, הנפקת קוד, רשימת מכשירים וביטול, דגל "לא נקרא", **סכום חודשי כמספר עם סה"כ**, שיטת תשלום כמלל, שינוי שם בעיפרון, ובניית אינדקס מחדש.
...
### בדיקות
32 קבצי מבחן, 1049 בדיקות. חדשים: מחסן התוכניות (כולל **מרוץ אמיתי** של עשר שמירות בו-זמנית), גבול האבטחה, שכבת הגישה, הנוסח המשפטי, ה-API מקצה לקצה, שני העמודים החדשים, והסרת המאמן מהאפליקציה.
