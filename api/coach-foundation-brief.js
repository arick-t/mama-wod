...
module.exports =
  ...
  "Lift kg ≠ barbell/rings permission — map to reported implements. Weekly: include lunge-family + wall pattern when indoors; thrusters valid CF — anti-spam ≠ ban.\n" +
  ...
  "- Clock-blocked: Mobility 3–4 → warm-up 4–9 → strength/skill 10–15 → conditioning 12–36 → short accessory. " +
  "Strength often 4–5×5 @ ~75–80% with intent tags; conditioning tagged (aerobic power / muscular endurance).\n" +
  "- Stimulus-forward: purposeful warm-up → %1RM waves with mono flush between sets → " +
