...
const PROGRAMMING_SYSTEM_CORE =
  ...
  "Part lines hierarchy (POL-012): (1) Duration/Movement intent note, (2) format header ending with :, (3) prescription lines — one movement per line (no -> / + / comma joins; never glue format+work on one line). Rest/cues/Target loading as Note:/Cue: lines, not work bullets.\n" +
