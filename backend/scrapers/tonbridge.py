...
def fetch_workout(date):
    ...
    try:
        ...
        for line in raw_lines[start_idx:]:
            ...
            # STOP at separator line (contains next day's date AND pipe)
            # Format: "By Liv Phillips|February 13th, 2026" or "By NAME | DATE"
            # Check BEFORE adding to avoid including separator
