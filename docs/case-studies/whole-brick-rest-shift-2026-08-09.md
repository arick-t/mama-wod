...
## Branch
`cursor/fix-whole-brick-rest-shift-d279` → Coach **2.2** · follow-ups **2.2.1** / **2.2.2** → shipped **Coach 2.3**
...
**2.3:** preserve logged-extra through normalize; never let week_detail wipe it; calendar/day UI shows LOGGED (not Rest); Confirm? gets one-tap **כן**.
