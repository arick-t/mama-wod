...
(function (root, factory) {
  ...
  var MAX_AGE = 90;
  /**
   * Ticks, not one answer, and "mixed" leads them.
   *
   * Mixed is what most rooms are, so it is ticked before anything is touched and stands
   * in a box of its own (owner, 2026-09-15). The three ability answers exclude each
   * other — "mixed ability AND beginners" reaches the coach as two contradictory facts
   * about one room, which is the failure this whole round has been closing — while who
   * is in the room is a separate fact that rides alongside any of them.
   *
   * "Women only" used to live on the group-kind list. It is here now and not there:
   * asking the same thing in two places is how the two answers come to disagree.
   */
  var LEVEL_DEFS = [
    { id: "mixed", label: "Mixed ability", lead: true, ability: true },
    { id: "beginners", label: "Beginners", ability: true },
    { id: "experienced", label: "Experienced", ability: true },
    { id: "competitive", label: "Competitive", ability: true },
  ...
  function emptyIntake() {
    return {
      ...
      ageFrom: 0,
      ageTo: 0,
      /* Mixed is the room most rooms are, so it is the answer the tab opens on. */
      levels: { mixed: true },
      groupTypes: {},
