 ...
 *
 * UMD on purpose: client.html loads this file directly as window.CLIENT_TERMS, so
 * the page and the server read the SAME text. A second browser copy of legal wording
 * would be a copy that can drift, and drift in legal text is not a cosmetic bug.
 *
 * Browser: <script src="lib/client-terms.js"></script> → CLIENT_TERMS
 * Node: require("../lib/client-terms.js")
 */
