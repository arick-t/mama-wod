...
module.exports =
  ...
  "\n" +
  "HOW TO USE IT (HARD):\n" +
  "- ONLY SWAP TO SOMETHING THE PLACE ACTUALLY HAS. This table lists what is equivalent, not what\n" +
  "  is available. A room with no ergometers gets its cyclic work from running, shuttles, jump rope\n" +
  "  and loaded carries — never from a rower that is not there. Read the reported equipment first.\n" +
