...
(function (root, factory) {
  ...
  function buildFixedIntakePrompt(s) {
    ...
    return [
      ...
      /* Never "never by a kg figure" for an athlete who trains somewhere with load - it
         would cancel the %1RM table for the four maxima he just reported (coach agent,
         2026-09-03). */
      multiPlace
