...
(function (root, factory) {
  ...
  var INTAKE_PROFILE_KEYS = [
    ...
    "competitor",
    /* A fact about the present, not a goal: it changes how heavy and how much (2026-09-15). */
    "inCalorieDeficit",
  ...
  function buildFixedIntakePrompt(s) {
    ...
    return [
      ...
      /* Not a goal: a fact about now. Training in a deficit changes how heavy and how much
         a month may be, and as a goal it tells the coach nothing (owner, 2026-09-15). */
      s.inCalorieDeficit === true
        ? "EATING RIGHT NOW: in a calorie deficit. Hold intensity and pull volume back rather " +
          "than the other way round; recovery is the limit this month."
        : "EATING RIGHT NOW: nothing reported - program normally.",
      avoidLabels.length
  ...
  function normalizeIntakeProfile(raw) {
    ...
    return {
      ...
      inCalorieDeficit: s.inCalorieDeficit === true,
