...
const LAYER3_TRIGGERS = {
  gymnastics:
    /\bgymnast\w*|\bhandstands?\b|\bhspu\b|\bmuscle[- ]?ups?\b|\bpull[- ]?ups?\b|\bchest[- ]to[- ]bar\b|\btoes[- ]to[- ]bar\b|\bttb\b|\bc2b\b|\brope climbs?\b|\bpistols?\b|\brings?\b|\bfront lever\b|\bback lever\b|\bkip(ping)?\b|\bbar muscle[- ]?up\b|\bstrict\b/i,
  weightlifting:
    /\bsnatch\w*|\bcleans?\b|\bclean and jerk\b|\bjerks?\b|\bolympic\b|\boly\b|\bbarbell\b|\b1rm\b|\bone rep max\b|\bback squat\b|\bfront squat\b|\boverhead squat\b|\bdeadlift\w*|\blift heavier\b|\bpush press\b|\bstrict press\b|\bshoulder press\b/i,
  endurance:
    /\bendurance\b|\bengine\b|\baerobic\b|\bzone ?2\b|\bvo2\b|\bcardio\b|\brun(ning)?\b|\brow(ing|er)?\b|\bski ?erg\b|\bskierg\b|\bassault bike\b|\bbike ?erg\b|\bconditioning base\b|\bgas out\b|\bout of breath\b|\b\d+ ?k\b|\bmarathon\b/i,
  partner: /\bpartner\b|\bpairs\b|\bteams? workout\b|\bbuddy\b|זוגות/i,
};
...
function pickLayer3(profile, studioIntake, explicit) {
  ...
  scored.slice(0, slots).forEach(function (r) {
    out.push(r.key);
  });
  return out;
}
