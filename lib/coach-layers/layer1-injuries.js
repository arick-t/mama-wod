...
module.exports =
  ...
  "AND IT ALSO REMOVES A SKILL THEY SAID THEY HAVE. An athlete may mark every skill as Rx-capable\n" +
  "and mark a pattern to avoid in the same intake. That is not a contradiction to resolve in favour\n" +
  "of the skill: the avoid list wins, and the skills that REQUIRE that pattern come off the menu in\n" +
  "the form that requires it. Deep squat avoided means no pistol, no squat snatch, no squat clean,\n" +
  "no overhead squat, no thruster — however confident the athlete is. Keep the FUNCTION with a\n" +
  "version that stays out of the bottom: power catches, partial-depth work, a box to squat to,\n" +
  "a split or a lunge instead of a pistol.\n" +
  "The intake states this outright in an 'AVOID OVERRIDES THESE MARKED SKILLS' line. Obey that line\n" +
  "as written; it is the resolution, not a suggestion.\n" +
  "\n" +
