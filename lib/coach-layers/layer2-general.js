 ...
 * says never to add a fifth week. The five-week brick still lives in ~80 places across
 * coach-foundation-brief.js, personal-coach.js, the POL rules, the intake contract and index.html
 * — that migration is its own branch, after the admin release. Nothing here depends on it: these
 * layers are unwired, so getting them right now is free.
 */
module.exports =
