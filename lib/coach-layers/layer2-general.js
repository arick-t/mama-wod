 ...
 *
 * THE CONJUGATE FRAME IS A PILOT. The owner's call on 2026-09-02: "אנחנו ניישם את זה כי אני חושב
 * שזה נכון לנו, עם זאת אנחנו נניע את זה כפיילוט ונראה אם התוצאה של מסגרת האימונים היא טובה
 * ואיכותית ואם לא אנחנו נוריד את המקור הזה מהמוח." So the max-effort / dynamic-effort spine ships
 * on trial. If the sessions it produces are not good, the block below comes out — it is written as
 * one contiguous section on purpose so it can be removed without unpicking anything else.
 *
...
module.exports =
  ...
  "Spread the three day CHARACTERS across the programmed days: SINGLE-ELEMENT, COUPLET, TRIPLET.\n" +
  "Rotate which modality (M / G / W) owns the single-element day, so that across a month each of\n" +
  "the three has had it.\n" +
  "This is a default shape, not a cycle to protect. It has no fixed period and no built-in rest\n" +
  "day: it is simply how a week stays balanced when nobody has told you what the week should be.\n" +
  "\n" +
