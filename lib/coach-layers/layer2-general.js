...
module.exports =
  ...
  "athlete — different people come on different days, so there is no shared rest day. Do NOT build\n" +
  "a 3-on/1-off cycle, and do NOT insert a rest day the intake did not ask for.\n" +
