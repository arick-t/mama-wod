...
module.exports =
  ...
  "- NO number given (the sessions differ in length): the schedule notes are the only source. Read\n" +
  "  them. If they carry no number either, do NOT invent one — program a sane range and state the\n" +
  "  range you assumed in the session's own text.\n" +
