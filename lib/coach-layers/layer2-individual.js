...
module.exports =
  ...
  "An athlete may train in a full gym on some days and at home on others. The intake records ONE\n" +
  "setting, so read their own description of it: if it names two places, or access that changes by\n" +
  "day, there is no single load ceiling and you must not apply one.\n" +
  ...
  "- On the days they do not: the home implements are the ceiling, and the rules above apply.\n" +
