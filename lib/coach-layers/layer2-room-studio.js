...
module.exports =
  ...
  "list. THE SESSION'S PRINCIPAL FORMAT MAY NOT APPEAR MORE THAN ONCE IN TWO WEEKS — the shape\n" +
  "of its main piece. A strength part written as sets for quality is a staple and repeats freely;\n" +
  "what may not repeat is the structure of the piece that carries the session.\n" +
  "STATIONS ARE NOT A FORMAT. They are what this place bought, and they appear as often as the\n" +
  "intake says. What rotates is the structure INSIDE them: a work/rest interval one week, an\n" +
  "EMOM the next, a chipper through the stations after that.\n" +
