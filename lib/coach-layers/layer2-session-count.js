...
module.exports =
  ...
  "- It may fix the PARTS (how many, and what each is for), the TIME CAP, the FORMAT, and whether\n" +
  "  the session has one piece or several. Honour all of it literally.\n" +
  "- 'One part only' means ONE part. Do not add a warm-up part, an accessory part or a second\n" +
  "  piece to a session that was described as having one.\n" +
  "- A named time cap is a ceiling, not a target to approach from above: 'under 10 minutes' means\n" +
  "  the piece must finish inside 10 minutes for the room, not for the fittest person in it.\n" +
