 ...
 * question, and it predates the move. The structured "are you competing?" field HAS since arrived —
 * the packet emits COMPETITOR: yes/no and competitorDeclared() reads it — so the gate is no longer
 ...
 *
 * DOUBLE DAYS ARE OUT PERMANENTLY, decided 2026-09-02: "יום כפול - לא חלק מהשירותים שאנחנו
 * נותנים - אין אצלינו דבר כזה." The source allows an intermediate competitor one double day a week
 * on their primary weakness — two separate sessions hours apart, because past about 75 minutes
 * session quality falls off and a competitor cannot fit strength, engine, gymnastics and weakness
 * work into one. Three reasons it does not apply here: the app renders ONE workout per calendar
 * day and has nowhere to put a second; every session is a billed call, and POL-COST-003 can block
 * the fill of the second one halfway; and it is specialisation itself, which is the opposite of
 * the owner's decision that a competitor here is trained broadly.
 *
 * "One session per programmed day" is a fact about the product rather than a rule about
 * competitors, so it now lives in layer2-general where it is always on. The line below is the
 * local restatement, kept because this is the one layer whose source actively pushes the other way.
 */
module.exports =
  ...
  "individual at all — their own training days from the intake ARE the weekly structure, and the\n" +
  "3-consecutive-day limit stated for every individual applies here unchanged. Three on, a lighter\n" +
  "day, then on again is also what a competitor's week is supposed to look like.\n" +
  "\n" +
  "HOW MANY DAYS THEY GET (HARD):\n" +
  "The days in their intake, and nothing else. A competitive goal does not earn an athlete more\n" +
  "sessions than they said they train. Someone with competitive ambition who trains three times a\n" +
  "week gets the three sessions that serve them best — not a four-day plan they will not follow.\n" +
  "Never infer a training volume from how serious the goal sounds.\n" +
  "SKILL SESSIONS are the one addition worth making: up to two low-intensity skill sessions a week,\n" +
  "8-10 minute EMOMs attached to the start or end of a session they already have. Attached — never\n" +
  ...
  "  farmer carry, double-unders. Real value, and they belong in conditioning — but they are not\n" +
  "  where dedicated strength and skill time goes.\n" +
  "HARD: this ranking is weighted by what a CONTEST tests — which is why the kipping pull-up sits at\n" +
  "the top and the thruster does not. Tier 3 movements may fill a metcon; they may not become the\n" +
  "development focus unless the athlete asked for exactly that.\n" +
  "\n" +
  ...
  "  rest\n" +
  "IF THIS SHAPE CLASHES WITH A DISCIPLINE LAYER, THIS ONE WINS. A discipline layer speaks about\n" +
  "one skill and caps how much of the week it may take; this layer is about preparing a competitor\n" +
  "BROADLY, and the barbell density here is breadth for them rather than specialisation.\n" +
  ...
  "- NO EVENT WEEK. Do not build a week around a contest date, and do not ask for one. We do not\n" +
  "  offer competition-day preparation and it is not who this product serves. A competitor here\n" +
  "  is trained broadly, every block, and a date they happen to mention changes nothing.\n" +
  ...
  "- NO DOUBLE DAYS, ever, at any level. A competitor here gets one session a day like everyone\n" +
  "  else. Extra work becomes another part of that session, not a second session.\n" +
