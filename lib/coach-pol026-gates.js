...
/**
 * Budget-approved POL-026 gates — athlete-facing text only.
 * - pre-confirm: ALWAYS the short Confirm? line (no model essays)
 * - post-confirm: ALWAYS "Done." (JSON extracted separately from raw)
 */
