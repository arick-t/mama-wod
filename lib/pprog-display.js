    ...
    var html =
      ...
      (viewFn
        ? '<button type="button" class="pprog-cal-view' + (calMode === "month" ? " on" : "") +
            '" onclick="' + viewFn + "('month')\" title=\"כל הלבנות, אחת מתחת לשנייה\">כל הלבנות</button>" +
          '<button type="button" class="pprog-cal-view' + (calMode === "block" ? " on" : "") +
            '" onclick="' + viewFn + "('block')\" title=\"רק הלבנה שאתה עומד בה\">לבנה נוכחית</button>" +
          '<button type="button" class="pprog-cal-view' + (calMode === "week" ? " on" : "") +
            '" onclick="' + viewFn + "('week')\" title=\"רק השבוע הזה\">השבוע</button>"
        : "") +
      "</div>";
    ...
    if (calMode === "month" || calMode === "block") {
      ...
      for (var gi = 0; gi < shown.length; gi++) {
        ...
        html +=
          ...
          '<div class="pprog-cal-block-title">לבנה ' + g.index + " · " + esc(groupLabel(g)) + "</div>" +
          dowRowHtml() +
