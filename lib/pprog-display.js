...
(function (root, factory) {
    ...
    for (var pi = 0; pi < parts.length; pi++) {
      ...
      html += headNum
        ? '<div class="section-title has-part-n">' +
          ...
          '<span class="pprog-part-name" dir="auto">' + esc(say(headName)) + "</span>" +
      ...
      for (ni = 0; ni < (classified.notes || []).length; ni++) {
        html += '<div class="pprog-part-note" dir="auto">' + esc(say(classified.notes[ni])) + "</div>";
      }
      if (classified.format) {
        html += '<div class="pprog-part-format" dir="auto">' + esc(say(classified.format)) + "</div>";
      }
      ...
      for (var ti = 0; ti < trailing.length; ti++) {
        html += '<div class="pprog-part-note" dir="auto">' + esc(say(trailing[ti])) + "</div>";
      }
      html += "</div>";
    }
    return html;
  ...
  function say(text) {
    ...
    if (!M || typeof M.bilingual !== "function") return text;
    return M.bilingual(text);
  }
