...
assert.ok(admin.includes("DUCK-WOD Admin · 2.0.2"), "admin product label 2.0.2");
assert.ok(/Admin 2\.0\.2/.test(admin) && /Coach 2\.3\.13/.test(admin), "admin shows Admin + Coach versions");
