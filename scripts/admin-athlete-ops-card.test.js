...
assert.ok(/DUCK-WOD Admin . 4\.2/.test(admin), "admin product label 4.2");
...
assert.ok(/Admin 4\.2/.test(admin) && /Coach 2\.3\.14/.test(admin), "admin shows Admin + Coach versions");
