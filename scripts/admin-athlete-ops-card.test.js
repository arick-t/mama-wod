...
assert.ok(admin.includes("DUCK-WOD Admin · 1.5.12"), "admin product label 1.5.12");
assert.ok(/Admin 1\.5\.12/.test(admin) && /Coach 2\.3\.13/.test(admin), "admin shows Admin + Coach versions");
