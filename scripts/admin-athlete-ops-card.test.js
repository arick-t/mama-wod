...
assert.ok(admin.includes("DUCK-WOD Admin · 4.0"), "admin product label 4.0");
...
assert.ok(/Admin 4\.0/.test(admin) && /Coach 2\.3\.14/.test(admin), "admin shows Admin + Coach versions");
