...
assert.ok(admin.includes("DUCK-WOD Admin · 3.0"), "admin product label 3.0");
assert.ok(/Admin 3\.0/.test(admin) && /Coach 2\.3\.13/.test(admin), "admin shows Admin + Coach versions");
